...
Install_RPM_Pack(){
	...
	#	curl -Ss --connect-timeout 3 -m 60 https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/btpanel-v7.7.0/install/yumRepo_select.sh|bash
	#fi
...
Install_Python_Lib(){
	curl -Ss --connect-timeout 3 -m 60 https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/btpanel-v7.7.0/install/pip_select.sh|bash
...
Install_Bt(){
	...
	wget -O /etc/init.d/bt https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/btpanel-v7.7.0/install/src/bt6.init -T 10
	wget -O /www/server/panel/install/public.sh https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/btpanel-v7.7.0/install/public.sh -T 10
	wget -O panel.zip https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/btpanel-v7.7.0/install/src/panel6.zip -T 10
	...
	wget -O /etc/init.d/bt https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/btpanel-v7.7.0/install/src/bt7.init -T 10
	wget -O /www/server/panel/init.sh https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/btpanel-v7.7.0/install/src/bt7.init -T 10
