...
#### 脚本安装
```bash
wget -O bt_happy.sh https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/bt_7.7_happy/bt_happy.sh && chmod +x bt_happy.sh && ./bt_happy.sh
```
...
```bash
wget https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/btpanel-v7.7.0/install/src/LinuxPanel-7.7.0.zip
unzip LinuxPanel-*
cd panel
bash update.sh
