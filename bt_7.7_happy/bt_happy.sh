...
if [ -f /www/server/panel/BTPanel/templates/default/soft.html ];then
    ...
    wget https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/bt_7.7_happy/soft.html
    chattr +i /www/server/panel/BTPanel/templates/default/soft.html
else
    cd /www/server/panel/BTPanel/templates/default
    wget https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/bt_7.7_happy/soft.html
...
if [ -f /www/server/panel/data/plugin.json ];then
    ...
    wget https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/bt_7.7_happy/plugin.json
    chattr +i /www/server/panel/data/plugin.json
else
    cd /www/server/panel/data
    wget https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/bt_7.7_happy/plugin.json
...
if [ -f /www/server/panel/BTPanel/templates/default/index.html ];then
    ...
    cd /www/server/panel/BTPanel/templates/default
    wget https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/bt_7.7_happy/index.html
else
    cd /www/server/panel/BTPanel/templates/default
    wget https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/bt_7.7_happy/index.html
fi
...
if [ -f /www/server/panel/task.py ];then
    ...
    cd /www/server/panel
    wget https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/bt_7.7_happy/task.py
    chattr +i /www/server/panel/task.py
else
    cd /www/server/panel
    wget https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/bt_7.7_happy/task.py
...
if [ -f /www/server/panel/data/repair.json ];then
    ...
    cd /www/server/panel/data
    wget https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/bt_7.7_happy/repair.json
    chattr +i /www/server/panel/data/repair.json
else
    cd /www/server/panel/data
    wget https://gh.988123.xyz/https://raw.githubusercontent.com/kingyan/btpanel-v7.7.0/main/bt_7.7_happy/repair.json
